          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Your trusted hardware partner</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Your one-stop destination for all hardware and ply needs. Quality products, competitive prices, and exceptional service.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Quality Tools</h3>
            <p className="text-gray-600">Professional-grade tools and equipment for all your projects.</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Ply & Timber</h3>
            <p className="text-gray-600">Premium quality plywood and timber for construction and furniture.</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Electrical Supplies</h3>
            <p className="text-gray-600">Complete range of electrical components and wiring solutions.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Visit our store for expert advice and competitive prices on all your hardware and construction needs.
          </p>
      ...
      <footer className="bg-white border-t border-orange-100 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center text-gray-600">
            ...
            <p className="mt-2">Your trusted partner for quality hardware solutions.</p>
          </div>
        </div>
      </footer>
    </div>
