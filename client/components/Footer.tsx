        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              We've been serving the community for over 15 years with premium quality hardware, 
              construction materials, and exceptional customer service. Your project success is our priority.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          ...
          <div className="mt-4 text-center">
            <p className="text-gray-500 text-xs">
              Licensed Hardware Dealer | Government Registered | 15+ Years of Trusted Service
            </p>
          </div>
        </div>
      </div>
