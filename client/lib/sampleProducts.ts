...
const SAMPLE_PRODUCTS: Omit<Product, "id" | "createdAt" | "updatedAt">[] = [
  // Hardware Tools & Equipment
  {
    ...
    description:
      "High-quality cordless drill with multiple bits for all your drilling needs",
  ...
  },
  {
    ...
    description:
      "Complete set of precision screwdrivers for various applications",
    category: "hardware-tools",
    price: 450.0,
    features: [
      "Magnetic Tips",
  ...
  // Plywood & Timber
  {
    ...
    description:
      "Premium waterproof plywood suitable for marine and outdoor applications",
  ...
  },
  {
    ...
    description:
      "Premium quality teak wood planks for furniture and interior work",
    category: "plywood-timber",
    price: 1800.0,
  ...
  },
  {
    ...
    description:
      "Standard commercial grade plywood for general construction use",
    category: "plywood-timber",
    price: 1450.0,
    features: [
      "BWR Grade",
  ...
  // Electrical Supplies
  {
    ...
    description:
      "Energy efficient LED tube lights for home and office illumination",
  ...
  },
  {
    ...
    description:
      "Modular switches and sockets for modern electrical installations",
    category: "electrical-supplies",
    price: 75.0,
    features: [
      "Modular Design",
  ...
  // Construction Materials
  {
    ...
    description:
      "High strength Portland cement for all construction applications",
  ...
  },
  {
    name: "Steel TMT Bars",
    description:
      "High tensile strength TMT bars for reinforced concrete construction",
    category: "construction-materials",
    price: 52.0,
    features: [
  ...
  },
  {
    ...
    description:
      "Complete set of bathroom fittings including shower and accessories",
    category: "plumbing-sanitation",
    price: 2200.0,
    features: [
      "Complete Set",
  ...
  },
  {
    ...
    description:
      "Professional quality paint brushes for all painting applications",
    category: "paint-finishing",
    price: 180.0,
    features: [
      "Natural Bristles",
  ...
  try {
    ...
    for (const productData of SAMPLE_PRODUCTS) {
      ...
      if (result.success) {
        ...
        errorCount++;
        console.error(
          `Failed to add sample product ${productData.name}:`,
          result.message,
        );
      }
    }
...
export function autoInitializeSampleProducts(): void {
  ...
  if (existingProducts.length === 0) {
    ...
    if (result.success) {
      ...
      console.error(
        "Failed to auto-initialize sample products:",
        result.message,
      );
    }
  }
